        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-white">Cache Components</h3>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed max-w-md">
              Demo de cómo funcionan los componentes con caché en Next.js 16
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  href="https://github.com/Braifz/cache-components-next-16"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors duration-200 text-sm"
                >
              ...
              <li>
                <a
                  href="https://www.braifz.dev/blog/cache-components"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors duration-200 text-sm"
                >
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2026 Cache Components Demo - Braifz
            </p>
